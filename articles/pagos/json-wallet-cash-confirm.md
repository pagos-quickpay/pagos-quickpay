...
```
curl -X POST \
  https://api.sandbox.connect.fif.tech/checkout/payments/{payment_method}/20190501001222\
  ...
  -d '{
        ...
        "reconciliation_id": "1111111",
        "store_id": "102",
        "terminal_id": "112",
        "terminal_timestamp": "2018-08-01T02:58:28.183Z",
        "accounting_date": "2018-08-01"
      }'
 ```
