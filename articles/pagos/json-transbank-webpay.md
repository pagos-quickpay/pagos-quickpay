...
- **acknowledge**: (DEPRECADO) desde esta URL se realiza acknowledge a Transbank.
...
Para confirmar una transacción en TRANSBANK una vez concluido el pago se debe llamar a esta URL, ejemplo:
